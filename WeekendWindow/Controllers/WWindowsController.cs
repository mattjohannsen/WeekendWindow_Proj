...
namespace WeekendWindow.Controllers
{
    public class WWindowsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.WWindow.Include(w => w.Viewer).Include(w => w.ViewerLocation);
        ...
        public async Task<IActionResult> Create([Bind("WWindowId,WWViewerId,WeekendLocationId,SaturdayDate,SundayDate,SaturdayWeatherId,SundayWeatherId,WeekendAttitudeId,WantLodging,WeekendLodgingId,TravelRadiusId")] WWindow wWindow)
        {
            if (ModelState.IsValid)
            {
                ...
                wWindow.WWViewerId = currentviewer.ViewerId;
            ...
            ViewData["WWViewerId"] = new SelectList(_context.Viewers, "ViewerId", "ViewerId", wWindow.WWViewerId);
            ViewData["WeekendLocationId"] = new SelectList(_context.ViewerLocation, "ViewerLocationId", "ViewerLocationName", wWindow.WeekendLocationId);
            return View(wWindow);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WWindowId,WWViewerId,WeekendLocationId,SaturdayDate,SundayDate,SaturdayWeatherId,SundayWeatherId,WeekendAttitudeId,WantLodging,WeekendLodgingId,TravelRadiusId")] WWindow wWindow)
        {
