...
namespace WeekendWindow.Services
{
    public class NearbyPlaceSearchRequest : INearbySearchRequest
    {
        ...
        {
            string url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=43.0389,-87.9065&radius=50000&type=bar&keyword=&key=AIzaSyDYYB2ZbLsO5Y7WiDcBgOrAsDhg08sbZVw";
